...
# Description gives information about the rpm package. This can be
# expanded up to multiple lines.
%description
Hello World app
...
# The installation. 
# We actually just put all our install files into a directory structure
# that mimics a server directory structure here
%install
